...
public class ModItems {
	...
	public static final int guiID_item_customnuke = 10107;
	...
	public static final Item part_plutonium = new ItemHazard(ALPHA,ItemHazard.pu, "part_plutonium").setCreativeTab(MainRegistry.controlTab);
	...
	public static class Materials {
		...
		public static class Ingots {
			...
			public static final Item ingot_red_aluminium = new ItemBase("ingot_red_aluminium").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item ingot_magnetized_tungsten = new ItemHazard(ALPHA,ItemHazard.magt, "ingot_magnetized_tungsten").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item ingot_technetium = new ItemHazard("ingot_technetium").addBeta(ItemHazard.tc99 * ItemHazard.ingot).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_tcalloy = new ItemHazard(BETA,0.07F, "ingot_tcalloy").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item ingot_ferrouranium = new ItemHazard("ingot_ferrouranium").addAlpha(ItemHazard.u * 0.5F).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item ingot_th232 = new ItemHazard(ALPHA,ItemHazard.th232, "ingot_th232").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_uranium = new ItemHazard(ALPHA,ItemHazard.u, "ingot_uranium").addRadon(2F).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_u233 = new ItemHazard(ALPHA,ItemHazard.u233, "ingot_u233").addRadon(2F).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_u235 = new ItemHazard(ALPHA,ItemHazard.u235, "ingot_u235").addRadon(2F).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_u238 = new ItemHazard(ALPHA,ItemHazard.u238, "ingot_u238").addRadon(2F).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_u238m2 = new ItemUnstable(350, 200, "ingot_u238m2").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_plutonium = new ItemHazard(ALPHA,ItemHazard.pu, "ingot_plutonium").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_pu238 = new ItemHazard(ALPHA,ItemHazard.pu238, true, false, "ingot_pu238").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_pu239 = new ItemHazard(ALPHA,ItemHazard.pu239, "ingot_pu239").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_pu240 = new ItemHazard(ALPHA,ItemHazard.pu240, "ingot_pu240").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_pu241 = new ItemHazard(ItemRads.plutonium241,"ingot_pu241").toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_pu_mix = new ItemHazard(ALPHA,ItemHazard.purg * ItemHazard.ingot, "ingot_pu_mix").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_am241 = new ItemHazard("ingot_am241").addAlpha(ItemHazard.am241 * ItemHazard.ingot).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item ingot_thorium_fuel = new ItemHazard(ALPHA,ItemHazard.thf, "ingot_thorium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_uranium_fuel = new ItemHazard(ALPHA,ItemHazard.uf, "ingot_uranium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_mox_fuel = new ItemHazard(ALPHA,ItemHazard.mox, "ingot_mox_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_plutonium_fuel = new ItemHazard(ALPHA,ItemHazard.puf, "ingot_plutonium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_neptunium_fuel = new ItemHazard(ALPHA,ItemHazard.npf, true, "ingot_neptunium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_americium_fuel = new ItemHazard(ALPHA,ItemHazard.amf, "ingot_americium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_les = new ItemHazard(ALPHA,ItemHazard.les, false, true, "ingot_les").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_schrabidium_fuel = new ItemHazard(ALPHA,ItemHazard.saf, false, true, "ingot_schrabidium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_hes = new ItemHazard(ALPHA,ItemHazard.hes, false, true, "ingot_hes").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_neptunium = new ItemHazard(ALPHA,ItemHazard.np237, true, "ingot_neptunium").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_tennessine = new ItemHazard(ALPHA,120F, "ingot_tennessine").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_polonium = new ItemHazard(ALPHA,ItemHazard.po210, true, "ingot_polonium").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_phosphorus = new ItemHazard(null,0F, true, "ingot_phosphorus").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item ingot_co60 = new ItemHazard(ItemRads.cobalt60, "ingot_co60").addFire(5).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item ingot_sr90 = new ItemHazard(BETA,ItemHazard.sr90, true, "ingot_sr90").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_iodine = new ItemCustomLore("ingot_iodine").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_i131 = new ItemHazard(BETA,ItemHazard.i131, "ingot_i131").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_au198 = new ItemHazard(ItemRads.gold198,"ingot_au198").addFire(15).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_pb209 = new ItemHazard(BETA,ItemHazard.pb209, true, true, "ingot_pb209").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_ra226 = new ItemHazard(ALPHA,ItemHazard.ra226, "ingot_ra226").addRadon(5F).addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_ac227 = new ItemHazard(BETA,ItemHazard.ac227, "ingot_ac227").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_gh336 = new ItemHazard(BETA,ItemHazard.gh336, "ingot_gh336").setCreativeTab(MainRegistry.partsTab);
			public static final Item ingot_radspice = new ItemHazard(GAMMA,ItemHazard.radspice, "ingot_radspice").addFire(15).addToxic(2).addBlinding().addHydroReactivity(6).toItem().setCreativeTab(MainRegistry.partsTab);
		...
		public static class Powders {
			...
			public static final Item powder_magnetized_tungsten = new ItemHazard(ALPHA,ItemHazard.magt * ItemHazard.powder, "powder_magnetized_tungsten").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item powder_caesium = new ItemHazard(null,0.0F, true, "powder_caesium").addHydroReactivity(5).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item powder_magic = new ItemOhNo("powder_magic").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item powder_balefire = new ItemHazard("powder_balefire").addRadiation(ItemHazard.bf * ItemHazard.powder).addFire(5).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item powder_co60 = new ItemContaminating(ItemRads.cobalt60, ItemHazard.powder, "powder_co60", true).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item powder_co60_tiny = new ItemContaminating(ItemRads.cobalt60, ItemHazard.powder_tiny, "powder_co60_tiny", true).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item powder_cs137 = new ItemContaminating(ItemHazard.cs137 * ItemHazard.powder, "powder_cs137").addHydroReactivity(5).addFire(5).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item powder_cs137_tiny = new ItemContaminating(ItemHazard.cs137 * ItemHazard.powder_tiny, "powder_cs137_tiny").addHydroReactivity(5).addFire(5).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item powder_au198 = new ItemContaminating(ItemRads.gold198, ItemHazard.powder, "powder_au198").addFire(15).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item powder_au198_tiny = new ItemContaminating(ItemRads.gold198, ItemHazard.powder_tiny, "powder_au198_tiny").addFire(15).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item powder_radspice = new ItemContaminating(ItemHazard.radspice * ItemHazard.powder, "powder_radspice").addFire(15).addToxic(3).addBlinding().addHydroReactivity(6).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item powder_radspice_tiny = new ItemContaminating(ItemHazard.radspice * ItemHazard.powder_tiny, "powder_radspice_tiny").addFire(15).addToxic(1).addBlinding().addHydroReactivity(6).toItem().setCreativeTab(MainRegistry.partsTab);
		}
		public static class Nuggies {
			...
			public static final Item nugget_u238 = new ItemHazard(ALPHA,ItemHazard.u238 * ItemHazard.nugget, "nugget_u238").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_u238m2 = new ItemUnstable(60, 2000, "nugget_u238m2").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_plutonium = new ItemHazard(ALPHA,ItemHazard.pu * ItemHazard.nugget, "nugget_plutonium").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_pu238 = new ItemHazard(ALPHA,ItemHazard.pu238 * ItemHazard.nugget, true, "nugget_pu238").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_pu239 = new ItemHazard(ALPHA,ItemHazard.pu239 * ItemHazard.nugget, "nugget_pu239").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_pu240 = new ItemHazard(ALPHA,ItemHazard.pu240 * ItemHazard.nugget, "nugget_pu240").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_th232 = new ItemHazard(ALPHA,ItemHazard.th232 * ItemHazard.nugget, "nugget_th232").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_pu241 = new ItemHazard(ItemRads.plutonium241, ItemHazard.nugget, "nugget_pu241").addFire(1).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_pu_mix = new ItemHazard(ALPHA,ItemHazard.purg * ItemHazard.nugget, "nugget_pu_mix").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_am241 = new ItemHazard(ALPHA,ItemHazard.am241 * ItemHazard.nugget, "nugget_am241").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_am242 = new ItemHazard(BETA,ItemHazard.am242 * ItemHazard.nugget, "nugget_am242").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_am_mix = new ItemHazard(BETA,ItemHazard.amrg * ItemHazard.nugget, "nugget_am_mix").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_technetium = new ItemHazard(BETA,ItemHazard.tc99 * ItemHazard.nugget, "nugget_technetium").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_neptunium = new ItemHazard(ALPHA,ItemHazard.np237 * ItemHazard.nugget, true, "nugget_neptunium").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_polonium = new ItemHazard(ALPHA,ItemHazard.po210 * ItemHazard.nugget, true, "nugget_polonium").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_thorium_fuel = new ItemHazard(ALPHA,ItemHazard.thf * ItemHazard.nugget, "nugget_thorium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_uranium_fuel = new ItemHazard(ALPHA,ItemHazard.uf * ItemHazard.nugget, "nugget_uranium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_mox_fuel = new ItemHazard(ALPHA,ItemHazard.mox * ItemHazard.nugget, "nugget_mox_fuel").setCreativeTab(MainRegistry.partsTab).setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_plutonium_fuel = new ItemHazard(ALPHA,ItemHazard.puf * ItemHazard.nugget, "nugget_plutonium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_neptunium_fuel = new ItemHazard(ALPHA,ItemHazard.npf * ItemHazard.nugget, true, "nugget_neptunium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_americium_fuel = new ItemHazard(ALPHA,ItemHazard.amf * ItemHazard.nugget, "nugget_americium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_les = new ItemHazard(ALPHA,ItemHazard.les * ItemHazard.nugget, false, true, "nugget_les").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_schrabidium_fuel = new ItemHazard(ALPHA,ItemHazard.saf * ItemHazard.nugget, "nugget_schrabidium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_hes = new ItemHazard(ALPHA,ItemHazard.hes * ItemHazard.nugget, false, true, "nugget_hes").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item nugget_zirconium = new ItemHazard("nugget_zirconium").addSharp(10).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item nugget_schrabidium = new ItemHazard(ALPHA,ItemHazard.sa326 * ItemHazard.nugget, false, true, "nugget_schrabidium").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_solinium = new ItemHazard(ALPHA,ItemHazard.sa327 * ItemHazard.nugget, false, true, "nugget_solinium").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item nugget_ac227 = new ItemHazard(BETA,ItemHazard.ac227 * ItemHazard.nugget, "nugget_ac227").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_cobalt = new ItemCustomLore("nugget_cobalt").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_co60 = new ItemHazard(ItemRads.cobalt60, ItemHazard.nugget,"nugget_co60").addFire(5).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item nugget_sr90 = new ItemHazard(BETA,ItemHazard.sr90 * ItemHazard.nugget, true, "nugget_sr90").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_pb209 = new ItemHazard(BETA,ItemHazard.pb209 * ItemHazard.nugget, true, true, "nugget_pb209").addToxic(1).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_gh336 = new ItemHazard(BETA,ItemHazard.gh336 * ItemHazard.nugget, "nugget_gh336").setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_au198 = new ItemHazard(ItemRads.gold198, ItemHazard.nugget, "nugget_au198").addFire(15).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_ra226 = new ItemHazard(ALPHA,ItemHazard.ra226 * ItemHazard.nugget, "nugget_ra226").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item nugget_radspice = new ItemHazard(GAMMA,ItemHazard.radspice * ItemHazard.nugget, "nugget_radspice").addFire(15).addToxic(1).addBlinding().addHydroReactivity(6).toItem().setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item nugget_unobtainium_greater = new ItemHazard(NEUTRONS,1000, "nugget_unobtainium_greater").setCreativeTab(MainRegistry.partsTab);
		...
		public static class Billets {
			...
			public static final Item billet_u235 = new ItemHazard(ALPHA,ItemHazard.u235 * ItemHazard.billet, "billet_u235").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_u238 = new ItemHazard(ALPHA,ItemHazard.u238 * ItemHazard.billet, "billet_u238").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_plutonium = new ItemHazard(ALPHA,ItemHazard.pu * ItemHazard.billet, "billet_plutonium").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_pu238 = new ItemHazard(ALPHA,ItemHazard.pu238 * ItemHazard.billet, true, "billet_pu238").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_pu239 = new ItemHazard(ALPHA,ItemHazard.pu239 * ItemHazard.billet, "billet_pu239").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_pu240 = new ItemHazard(ALPHA,ItemHazard.pu240 * ItemHazard.billet, "billet_pu240").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_pu241 = new ItemHazard(ItemRads.plutonium241, ItemHazard.billet, "billet_pu241").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_pu_mix = new ItemHazard(ALPHA,ItemHazard.purg * ItemHazard.billet, "billet_pu_mix").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_am241 = new ItemHazard(ALPHA,ItemHazard.am241 * ItemHazard.billet, "billet_am241").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_am242 = new ItemHazard(BETA,ItemHazard.am242 * ItemHazard.billet, "billet_am242").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_am_mix = new ItemHazard(BETA,ItemHazard.amrg * ItemHazard.billet, "billet_am_mix").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_neptunium = new ItemHazard(ALPHA,ItemHazard.np237 * ItemHazard.billet, true, "billet_neptunium").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_polonium = new ItemHazard(ALPHA,ItemHazard.po210 * ItemHazard.billet, true, "billet_polonium").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_technetium = new ItemHazard(BETA,ItemHazard.tc99 * ItemHazard.billet, "billet_technetium").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_co60 = new ItemHazard(ItemRads.cobalt60, ItemHazard.billet, "billet_co60").addFire(5).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_sr90 = new ItemHazard(BETA,ItemHazard.sr90 * ItemHazard.billet, "billet_sr90").addHydroReactivity().addFire(5).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_au198 = new ItemHazard(ItemRads.gold198, ItemHazard.billet, "billet_au198").addFire(15).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_pb209 = new ItemHazard(BETA,ItemHazard.pb209 * ItemHazard.billet, true, true, "billet_pb209").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_ra226 = new ItemHazard(ALPHA,ItemHazard.ra226 * ItemHazard.billet, "billet_ra226").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_ac227 = new ItemHazard(BETA,ItemHazard.ac227 * ItemHazard.billet, "billet_ac227").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_gh336 = new ItemHazard(BETA,ItemHazard.gh336 * ItemHazard.billet, "billet_gh336").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item billet_zfb_bismuth = new ItemHazard(NEUTRONS,ItemHazard.zfb_bi * ItemHazard.billet, "billet_zfb_bismuth").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_zfb_pu241 = new ItemHazard(NEUTRONS,ItemHazard.zfb_pu241 * ItemHazard.billet, "billet_zfb_pu241").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_zfb_am_mix = new ItemHazard(NEUTRONS,ItemHazard.zfb_am_mix * ItemHazard.billet, "billet_zfb_am_mix").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_schrabidium = new ItemHazard(ALPHA,ItemHazard.sa326 * ItemHazard.billet, false, true, "billet_schrabidium").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_solinium = new ItemHazard(ALPHA,ItemHazard.sa327 * ItemHazard.billet, false, true, "billet_solinium").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_thorium_fuel = new ItemHazard(ALPHA,ItemHazard.thf * ItemHazard.billet, "billet_thorium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_uranium_fuel = new ItemHazard(ALPHA,ItemHazard.uf * ItemHazard.billet, "billet_uranium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_mox_fuel = new ItemHazard(ALPHA,ItemHazard.mox * ItemHazard.billet, "billet_mox_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_plutonium_fuel = new ItemHazard(ALPHA,ItemHazard.puf * ItemHazard.billet, "billet_plutonium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_neptunium_fuel = new ItemHazard(ALPHA,ItemHazard.npf * ItemHazard.billet, true, "billet_neptunium_fuel").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_americium_fuel = new ItemHazard(ALPHA,ItemHazard.amf * ItemHazard.billet, "billet_americium_fuel").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item billet_unobtainium = new ItemHazard(NEUTRONS,ItemHazard.unof * ItemHazard.billet, "billet_unobtainium").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_yharonite = new ItemBase("billet_yharonite").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_balefire_gold = new ItemHazard(BETA,ItemHazard.au198 * ItemHazard.billet, true, "billet_balefire_gold").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_flashlead = new ItemHazard(BETA,ItemHazard.aupb * ItemHazard.billet, true, true, "billet_flashlead").setCreativeTab(MainRegistry.partsTab);
			public static final Item billet_nuclear_waste = new ItemContaminating(ItemRads.waste, ItemHazard.billet, "billet_nuclear_waste").setCreativeTab(MainRegistry.partsTab);
		}
		public static class Crystals {
			...
			public static final Item crystal_uranium = new ItemHazard(ALPHA,ItemHazard.u * ItemHazard.crystal, "crystal_uranium").setCreativeTab(MainRegistry.partsTab);
			public static final Item crystal_thorium = new ItemHazard(ALPHA,ItemHazard.th232 * ItemHazard.crystal, "crystal_thorium").setCreativeTab(MainRegistry.partsTab);
			public static final Item crystal_plutonium = new ItemHazard(ALPHA,ItemHazard.pu * ItemHazard.crystal, "crystal_plutonium").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item crystal_schraranium = new ItemHazard(ALPHA,ItemHazard.sr * ItemHazard.crystal, false, true, "crystal_schraranium").setCreativeTab(MainRegistry.partsTab);
			public static final Item crystal_schrabidium = new ItemHazard(ALPHA,ItemHazard.sa326 * ItemHazard.crystal, false, true, "crystal_schrabidium").setCreativeTab(MainRegistry.partsTab);
			public static final Item crystal_rare = new ItemBase("crystal_rare").setCreativeTab(MainRegistry.partsTab);
			public static final Item crystal_phosphorus = new ItemHazard(null,0.0F, true, "crystal_phosphorus").setCreativeTab(MainRegistry.partsTab);
			...
			public static final Item crystal_trixite = new ItemHazard(ALPHA,10.0F, "crystal_trixite").addCryogenic(2).toItem().setCreativeTab(MainRegistry.partsTab);
		...
		static {
			MainRegistry._initMemberClasses(Materials.class);
		}
	}
	...
	public static final Item nuclear_waste = new ItemContaminating(ItemRads.waste, ItemHazard.powder, "nuclear_waste").setCreativeTab(MainRegistry.partsTab);
	public static final Item nuclear_waste_tiny = new ItemContaminating(ItemRads.waste, ItemHazard.powder_tiny, "nuclear_waste_tiny").setCreativeTab(MainRegistry.partsTab);
	public static final Item nuclear_waste_vitrified = new ItemContaminating(ItemRads.waste_v, ItemHazard.powder, "nuclear_waste_vitrified").setCreativeTab(MainRegistry.partsTab);
	public static final Item nuclear_waste_vitrified_tiny = new ItemContaminating(ItemRads.waste_v, ItemHazard.powder_tiny, "nuclear_waste_vitrified_tiny").setCreativeTab(MainRegistry.partsTab);
	public static final Item waste_uranium = new ItemContaminating(ALPHA,15F, "waste_uranium").addRadon(5).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item waste_thorium = new ItemContaminating(ALPHA,10F, "waste_thorium").addRadon(5).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item waste_plutonium = new ItemContaminating(ALPHA,15F, "waste_plutonium").addRadon(5).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item waste_mox = new ItemContaminating(ALPHA,15F, "waste_mox").addRadon(5).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item waste_schrabidium = new ItemContaminating(ALPHA,40F, false, true, "waste_schrabidium").addRadon(5).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item waste_uranium_hot = new ItemContaminating(ALPHA,15F, true, "waste_uranium_hot").addRadon(15).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item waste_thorium_hot = new ItemContaminating(ALPHA,10F, true, "waste_thorium_hot").addRadon(15).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item waste_plutonium_hot = new ItemContaminating(15F, true, "waste_plutonium_hot").addRadon(15).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item waste_mox_hot = new ItemContaminating(ALPHA,15F, true, "waste_mox_hot").addRadon(15).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item waste_schrabidium_hot = new ItemContaminating(ALPHA,40F, true, true, "waste_schrabidium_hot").addRadon(15).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item fallout = new ItemHazard(ACTIVATION,ItemHazard.fo, "falloutitem").setCreativeTab(MainRegistry.partsTab);
	...
	public static class LeafiaRods {
		...
		public static final Item
				...
				.setAppearance(Billets.billet_uranium_fuel, BILLET, FUEL)
		...
		public static final Item
				...
				.setAppearance(Billets.billet_u233, BILLET, ISOTOPE)
				.setReactivity(2)
		...
		public static final Item
				...
				.setAppearance(Billets.billet_u235, BILLET, ISOTOPE)
				.setReactivity(1.75)
				.setDecayProduct("depleteduranium")
		...
		public static final Item
				...
				.setAppearance(Billets.billet_thorium_fuel, BILLET, FUEL)
		...
		public static final Item
				...
				.setAppearance(Billets.billet_plutonium_fuel, BILLET, FUEL)
				.setReactivity(1/1.5)
		...
		public static final Item
				...
				.setAppearance(Billets.billet_pu_mix, BILLET, ISOTOPE)
				.setDecayProduct("depletedplutonium")
		...
		public static final Item
				...
				.setAppearance(Billets.billet_pu239, BILLET, ISOTOPE)
				.setReactivity(1.25)
		...
		public static final Item
				...
				.setAppearance(Billets.billet_pu241, BILLET, ISOTOPE)
				.setReactivity(1.45)
				.setDecayProduct("depletedplutonium")
				.addRadiation(ItemRads.plutonium241, ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodLEA242
				= new LeafiaRodItem("LEAm-242",1800000, 3986)
				.setAppearance(Billets.billet_americium_fuel, BILLET, FUEL)
				.addAlpha(ItemHazard.amf * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodMEA242
				= new LeafiaRodItem("MEAm-242",1800000, 3986)
				.setAppearance(Billets.billet_am_mix, BILLET, ISOTOPE)
				.addBeta(ItemHazard.amrg * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodHEA241
				= new LeafiaRodItem("HEAm-241",1800000, 3986)
				.setAppearance(Billets.billet_am241, BILLET, ISOTOPE)
				.preferFast()
		...
		public static final Item
				...
				.setAppearance(Billets.billet_am242, BILLET, ISOTOPE)
				.addBeta(ItemHazard.am242 * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodMEN237
				= new LeafiaRodItem("MENp-237",520000, 2800)
				.setAppearance(Billets.billet_neptunium_fuel, BILLET, FUEL)
				.preferAny()
		...
		public static final Item
				...
				.setAppearance(Billets.billet_neptunium, BILLET, RAW)
				.preferFast()
		...
		public static final Item
				...
				.setAppearance(Billets.billet_mox_fuel, BILLET, FUEL)
				.addAlpha(ItemHazard.mox * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodLES236
				= new LeafiaRodItem("LESa-326",350000, 2500)
				.setAppearance(Billets.billet_les, BILLET, FUEL)
				.setEmission(0.75)
				.setModerated()
		...
		public static final Item
				...
				.setAppearance(Billets.billet_schrabidium_fuel, BILLET, FUEL)
		...
		public static final Item
				...
				.setAppearance(Billets.billet_hes, BILLET, FUEL)
				.setEmission(1.25)
		...
		public static final Item
				...
				.setAppearance(Billets.billet_schrabidium, BILLET, FUEL)
				.setEmission(2.25)
				.addAlpha(ItemHazard.sa326 * ItemHazard.billet)
				.addBlinding()
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodLEAus
				= new LeafiaRodItem("LEAus",550000, 7029)
				.setAppearance(Billets.billet_australium_lesser, BILLET, ISOTOPE)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodHEAus
				= new LeafiaRodItem("HEAus",550000, 5211)
				.setAppearance(Billets.billet_australium_greater, BILLET, ISOTOPE)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodEmitter
		...
		public static final Item
				...
				.setAppearance(Billets.billet_ra226be, BILLET, SOURCE)
				.setModerated()
		...
		public static final Item
				...
				.setAppearance(Billets.billet_po210be, BILLET, SOURCE)
				.setModerated()
		...
		public static final Item
				...
				.setAppearance(Billets.billet_pu238be, BILLET, SOURCE)
				.setModerated()
		...
		public static final Item
				...
				.setAppearance(Billets.billet_balefire_gold, BILLET, RAW)
				.addBeta(ItemHazard.au198 * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodFlashlead
				= new LeafiaRodItem("Flashlead",2200000, 5050)
				.setAppearance(Billets.billet_flashlead, BILLET, RAW)
				.addBeta(ItemHazard.aupb * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodBi209ZFB
				= new LeafiaRodItem("Bi-209 ZFB",180000, 2744)
				.setAppearance(Billets.billet_zfb_bismuth, BILLET, BREEDER)
				.addRadiation(ItemHazard.zfb_bi * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodPu241ZFB
				= new LeafiaRodItem("Pu-241 ZFB",180000, 2865)
				.setAppearance(Billets.billet_zfb_pu241, BILLET, BREEDER)
				.addRadiation(ItemHazard.zfb_pu241 * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodAm242ZFB
				= new LeafiaRodItem("Am-242 ZFB",180000, 3744)
				.setAppearance(Billets.billet_zfb_am_mix, BILLET, BREEDER)
				.addRadiation(ItemHazard.zfb_am_mix * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		// normal rods-based
		public static final Item
				leafRodPu238
				= new LeafiaRodItem("Pu-238",350000, 2744)
				.setAppearance(Billets.billet_pu238, BILLET, ISOTOPE)
				.addAlpha(ItemHazard.pu238 * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodPo210
				= new LeafiaRodItem("Po-210",300000, 1287)
				.setAppearance(Billets.billet_polonium, BILLET, ISOTOPE)
		...
		public static final Item
				...
				.setAppearance(Billets.billet_pu240, BILLET, ISOTOPE)
				.addAlpha(ItemHazard.pu240 * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodWasteUranium
				= new LeafiaRodItem("Depleted Uranium",0, 0)
				.setAppearance(waste_uranium_hot, BONEMEAL, RAW)
				.addAlpha(12F)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodWastePlutonium
				= new LeafiaRodItem("Depleted Plutonium",0, 0)
				.setAppearance(waste_plutonium_hot, BONEMEAL, RAW)
				.addAlpha(19F)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodWasteThorium
				= new LeafiaRodItem("Depleted Thorium",0, 0)
				.setAppearance(waste_thorium_hot, BONEMEAL, RAW)
				.addAlpha(8F)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodWasteMOX
				= new LeafiaRodItem("Depleted MOX",0, 0)
				.setAppearance(waste_mox_hot, BONEMEAL, RAW)
				.addAlpha(12F)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodWasteSchrabidium
				= new LeafiaRodItem("Depleted Schrabidium",0, 0)
				.setAppearance(waste_schrabidium_hot, BONEMEAL, RAW)
				.addAlpha(35F)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodLead
				= new LeafiaRodItem("Lead",99999999, 0)
				.setAppearance(Ingots.ingot_lead, BILLET, RAW)
				.addToxic(2)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodBF
		...
		public static final Item
				...
				.setAppearance(Billets.billet_plutonium, BILLET, RAW)
		...
		public static final Item
				...
				.setAppearance(Billets.billet_bismuth, BILLET, RAW)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodGold198
				= new LeafiaRodItem("Au-198",900000, 3850)
				.setAppearance(Billets.billet_au198, BILLET, ISOTOPE)
				.addBeta(ItemHazard.au198 * ItemHazard.billet)
				.toItem().setCreativeTab(MainRegistry.controlTab);
		public static final Item
				leafRodLead209
	...
	public static class RetroRods {
		public static final Item rod_empty = new ItemBase("rod_empty").setCreativeTab(MainRegistry.controlTab);
		public static final Item rod_daffergon = new ItemCustomLore("rod_daffergon").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_unobtainium = new ItemCustomLore("rod_unobtainium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_verticium = new ItemCustomLore("rod_verticium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_australium = new ItemCustomLore("rod_australium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_weidanium = new ItemCustomLore("rod_weidanium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_reiium = new ItemCustomLore("rod_reiium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_euphemium = new ItemCustomLore("rod_euphemium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_ra226 = new ItemHazard(ALPHA,ItemHazard.ra226 * ItemHazard.rod, "rod_ra226").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_co60 = new ItemHazard(ItemRads.cobalt60, ItemHazard.rod, "rod_co60").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_cobalt = new ItemBase("rod_cobalt").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_ac227 = new ItemHazard(BETA,ItemHazard.ac227 * ItemHazard.rod, "rod_ac227").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_tritium = new ItemHazard(ItemRads.tritium, ItemHazard.rod, "rod_tritium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_lithium = new ItemCustomLore("rod_lithium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_coolant = new ItemHazard("rod_coolant").addCryogenic(1).toItem().setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_water = new ItemCustomLore("rod_water").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_waste = new ItemHazard(ACTIVATION,ItemHazard.wst * ItemHazard.rod, "rod_waste").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_schrabidium_fuel_depleted = new ItemHazard(ACTIVATION,40F, true, "rod_schrabidium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_mox_fuel_depleted = new ItemHazard(ACTIVATION,15F, true, "rod_mox_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_plutonium_fuel_depleted = new ItemHazard(ACTIVATION,15F, true, "rod_plutonium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_uranium_fuel_depleted = new ItemHazard(ACTIVATION,15F, true, "rod_uranium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_thorium_fuel_depleted = new ItemHazard(ACTIVATION,10F, true, "rod_thorium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_schrabidium_fuel = new ItemFuelRod(ItemHazard.sa326 * ItemHazard.rod, true, 100000, 125, "rod_schrabidium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_mox_fuel = new ItemFuelRod(ItemHazard.mox * ItemHazard.rod, false, 300000, 20, "rod_mox_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_plutonium_fuel = new ItemFuelRod(ItemHazard.puf * ItemHazard.rod, false, 150000, 40, "rod_plutonium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_uranium_fuel = new ItemFuelRod(ItemHazard.uf * ItemHazard.rod, false, 250000, 30, "rod_uranium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_thorium_fuel = new ItemFuelRod(ItemHazard.thf * ItemHazard.rod, false, 400000, 15, "rod_thorium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_balefire_blazing = new ItemHazard(GAMMA,ItemHazard.bf * ItemHazard.rod * 2, true, "rod_balefire_blazing").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_balefire = new ItemHazard(GAMMA,ItemHazard.bf * ItemHazard.rod, "rod_balefire").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_solinium = new ItemHazard(ALPHA,ItemHazard.sa327 * ItemHazard.rod, false, true, "rod_solinium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_schrabidium = new ItemHazard(ALPHA,ItemHazard.sa326 * ItemHazard.rod, false, true, "rod_schrabidium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_lead = new ItemBase("rod_lead").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_polonium = new ItemHazard(ALPHA,ItemHazard.po210 * ItemHazard.rod, "rod_polonium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_neptunium = new ItemHazard(ALPHA,ItemHazard.np237 * ItemHazard.rod, "rod_neptunium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_rgp = new ItemHazard(ALPHA,ItemHazard.purg * ItemHazard.rod, "rod_rgp").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_pu240 = new ItemHazard(ALPHA,ItemHazard.pu240 * ItemHazard.rod, "rod_pu240").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_pu239 = new ItemHazard(ALPHA,ItemHazard.pu239 * ItemHazard.rod, "rod_pu239").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_pu238 = new ItemHazard(ALPHA,ItemHazard.pu238 * ItemHazard.rod, "rod_pu238").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_plutonium = new ItemHazard(ALPHA,ItemHazard.pu * ItemHazard.rod, "rod_plutonium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_u238 = new ItemHazard(ALPHA,ItemHazard.u238 * ItemHazard.rod, "rod_u238").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_u235 = new ItemHazard(ALPHA,ItemHazard.u235 * ItemHazard.rod, "rod_u235").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_u233 = new ItemHazard(ALPHA,ItemHazard.u233 * ItemHazard.rod, "rod_u233").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_uranium = new ItemHazard(ALPHA,ItemHazard.u * ItemHazard.rod, "rod_uranium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_th232 = new ItemHazard(ALPHA,ItemHazard.th232 * ItemHazard.rod, "rod_th232").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_empty);
		public static final Item rod_dual_empty = new ItemBase("rod_dual_empty").setCreativeTab(MainRegistry.controlTab);
		public static final Item rod_dual_ra226 = new ItemHazard(ALPHA,ItemHazard.ra226 * ItemHazard.rod_dual, "rod_dual_ra226").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_co60 = new ItemHazard(ItemRads.cobalt60, ItemHazard.rod_dual, "rod_dual_co60").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_cobalt = new ItemBase("rod_dual_cobalt").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_ac227 = new ItemHazard(BETA,ItemHazard.ac227 * ItemHazard.rod_dual, "rod_dual_ac227").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_tritium = new ItemHazard(ItemRads.tritium, ItemHazard.rod_dual, "rod_dual_tritium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_lithium = new ItemCustomLore("rod_dual_lithium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_coolant = new ItemHazard("rod_dual_coolant").addCryogenic(2).toItem().setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_water = new ItemCustomLore("rod_dual_water").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_waste = new ItemHazard(ACTIVATION,30F, "rod_dual_waste").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_schrabidium_fuel_depleted = new ItemHazard(ACTIVATION,80F, true, "rod_dual_schrabidium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_mox_fuel_depleted = new ItemHazard(ACTIVATION,30F, true, "rod_dual_mox_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_plutonium_fuel_depleted = new ItemHazard(ACTIVATION,30F, true, "rod_dual_plutonium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_uranium_fuel_depleted = new ItemHazard(ACTIVATION,30F, true, "rod_dual_uranium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_thorium_fuel_depleted = new ItemHazard(ACTIVATION,20F, true, "rod_dual_thorium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_schrabidium_fuel = new ItemFuelRod(ItemHazard.sa326 * ItemHazard.rod_dual, true, 100000, 250, "rod_dual_schrabidium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_mox_fuel = new ItemFuelRod(ItemHazard.mox * ItemHazard.rod_dual, false, 300000, 40, "rod_dual_mox_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_plutonium_fuel = new ItemFuelRod(ItemHazard.puf * ItemHazard.rod_dual, false, 150000, 80, "rod_dual_plutonium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_uranium_fuel = new ItemFuelRod(ItemHazard.uf * ItemHazard.rod_dual, false, 250000, 60, "rod_dual_uranium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_thorium_fuel = new ItemFuelRod(ItemHazard.thf * ItemHazard.rod_dual, false, 400000, 30, "rod_dual_thorium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_balefire_blazing = new ItemHazard(GAMMA,ItemHazard.bf * ItemHazard.rod_dual * 2, true, "rod_dual_balefire_blazing").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_balefire = new ItemHazard(GAMMA,ItemHazard.bf * ItemHazard.rod_dual, "rod_dual_balefire").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_solinium = new ItemHazard(ALPHA,ItemHazard.sa327 * ItemHazard.rod_dual, false, true, "rod_dual_solinium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_schrabidium = new ItemHazard(ALPHA,ItemHazard.sa326 * ItemHazard.rod_dual, false, true, "rod_dual_schrabidium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_lead = new ItemBase("rod_dual_lead").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_polonium = new ItemHazard(ALPHA,ItemHazard.po210 * ItemHazard.rod_dual, "rod_dual_polonium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_neptunium = new ItemHazard(ALPHA,ItemHazard.np237 * ItemHazard.rod_dual, "rod_dual_neptunium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_rgp = new ItemHazard(ALPHA,ItemHazard.purg * ItemHazard.rod_dual, "rod_dual_rgp").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_pu240 = new ItemHazard(ALPHA,ItemHazard.pu240 * ItemHazard.rod_dual, "rod_dual_pu240").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_pu239 = new ItemHazard(ALPHA,ItemHazard.pu239 * ItemHazard.rod_dual, "rod_dual_pu239").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_pu238 = new ItemHazard(ALPHA,ItemHazard.pu238 * ItemHazard.rod_dual, "rod_dual_pu238").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_plutonium = new ItemHazard(ALPHA,ItemHazard.pu * ItemHazard.rod_dual, "rod_dual_plutonium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_u238 = new ItemHazard(ALPHA,ItemHazard.u238 * ItemHazard.rod_dual, "rod_dual_u238").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_u235 = new ItemHazard(ALPHA,ItemHazard.u235 * ItemHazard.rod_dual, "rod_dual_u235").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_u233 = new ItemHazard(ALPHA,ItemHazard.u233 * ItemHazard.rod_dual, "rod_dual_u233").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_uranium = new ItemHazard(ALPHA,ItemHazard.u * ItemHazard.rod_dual, "rod_dual_uranium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_dual_th232 = new ItemHazard(ALPHA,ItemHazard.th232 * ItemHazard.rod_dual, "rod_dual_th232").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_dual_empty);
		public static final Item rod_quad_empty = new ItemBase("rod_quad_empty").setCreativeTab(MainRegistry.controlTab);
		public static final Item rod_quad_euphemium = new ItemCustomLore("rod_quad_euphemium").setCreativeTab(MainRegistry.controlTab).setMaxStackSize(1).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_ra226 = new ItemHazard(ALPHA,ItemHazard.ra226 * ItemHazard.rod_quad, "rod_quad_ra226").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_co60 = new ItemHazard(ItemRads.cobalt60, ItemHazard.rod_quad, "rod_quad_co60").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_cobalt = new ItemBase("rod_quad_cobalt").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_ac227 = new ItemHazard(BETA,ItemHazard.ac227 * ItemHazard.rod_quad, "rod_quad_ac227").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_tritium = new ItemHazard(ItemRads.tritium, ItemHazard.rod_quad, "rod_quad_tritium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_lithium = new ItemCustomLore("rod_quad_lithium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_coolant = new ItemHazard("rod_quad_coolant").addCryogenic(4).toItem().setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_water = new ItemCustomLore("rod_quad_water").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_waste = new ItemHazard(ACTIVATION,60F, "rod_quad_waste").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_schrabidium_fuel_depleted = new ItemHazard(ACTIVATION,160F, true, "rod_quad_schrabidium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_mox_fuel_depleted = new ItemHazard(ACTIVATION,60F, true, "rod_quad_mox_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_plutonium_fuel_depleted = new ItemHazard(ACTIVATION,60F, true, "rod_quad_plutonium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_uranium_fuel_depleted = new ItemHazard(ACTIVATION,60F, true, "rod_quad_uranium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_thorium_fuel_depleted = new ItemHazard(ACTIVATION,40F, true, "rod_quad_thorium_fuel_depleted").setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_schrabidium_fuel = new ItemFuelRod(ItemHazard.sa326 * ItemHazard.rod_quad, true, 100000, 500, "rod_quad_schrabidium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_mox_fuel = new ItemFuelRod(ItemHazard.mox * ItemHazard.rod_quad, false, 300000, 80, "rod_quad_mox_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_plutonium_fuel = new ItemFuelRod(ItemHazard.puf * ItemHazard.rod_quad, false, 150000, 160, "rod_quad_plutonium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_uranium_fuel = new ItemFuelRod(ItemHazard.uf * ItemHazard.rod_quad, false, 250000, 120, "rod_quad_uranium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_thorium_fuel = new ItemFuelRod(ItemHazard.thf * ItemHazard.rod_quad, false, 400000, 60, "rod_quad_thorium_fuel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_balefire_blazing = new ItemHazard(GAMMA,ItemHazard.bf * ItemHazard.rod_quad * 2, true, "rod_quad_balefire_blazing").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_balefire = new ItemHazard(GAMMA,ItemHazard.bf * ItemHazard.rod_quad, "rod_quad_balefire").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_solinium = new ItemHazard(ALPHA,ItemHazard.sa327 * ItemHazard.rod_quad, false, true, "rod_quad_solinium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_schrabidium = new ItemHazard(ALPHA,ItemHazard.sa326 * ItemHazard.rod_quad, false, true, "rod_quad_schrabidium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_lead = new ItemBase("rod_quad_lead").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_polonium = new ItemHazard(ALPHA,ItemHazard.po210 * ItemHazard.rod_quad, "rod_quad_polonium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_neptunium = new ItemHazard(ALPHA,ItemHazard.np237 * ItemHazard.rod_quad, "rod_quad_neptunium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_rgp = new ItemHazard(ALPHA,ItemHazard.purg * ItemHazard.rod_quad, "rod_quad_rgp").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_pu240 = new ItemHazard(ALPHA,ItemHazard.pu240 * ItemHazard.rod_quad, "rod_quad_pu240").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_pu239 = new ItemHazard(ALPHA,ItemHazard.pu239 * ItemHazard.rod_quad, "rod_quad_pu239").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_pu238 = new ItemHazard(ALPHA,ItemHazard.pu238 * ItemHazard.rod_quad, "rod_quad_pu238").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_plutonium = new ItemHazard(ALPHA,ItemHazard.pu * ItemHazard.rod_quad, "rod_quad_plutonium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_u238 = new ItemHazard(ALPHA,ItemHazard.u238 * ItemHazard.rod_quad, "rod_quad_u238").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_u235 = new ItemHazard(ALPHA,ItemHazard.u235 * ItemHazard.rod_quad, "rod_quad_u235").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_u233 = new ItemHazard(ALPHA,ItemHazard.u233 * ItemHazard.rod_quad, "rod_quad_u233").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_uranium = new ItemHazard(ALPHA,ItemHazard.th232 * ItemHazard.rod_quad, "rod_quad_uranium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		public static final Item rod_quad_th232 = new ItemHazard(ALPHA,ItemHazard.th232 * ItemHazard.rod_quad, "rod_quad_th232").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(rod_quad_empty);
		//That's a lot of rods
	}


	//RTG
	public static final Item pellet_rtg_depleted_bismuth = new ItemHazard(ACTIVATION, 1F, "pellet_rtg_depleted_bismuth").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab);
	public static final Item pellet_rtg_depleted_lead = new ItemHazard(ACTIVATION,0.5F, "pellet_rtg_depleted_lead").addToxic(2).toItem().setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab);
	public static final Item pellet_rtg_depleted_mercury = new ItemHazard(ACTIVATION,4.25F, "pellet_rtg_depleted_mercury").addToxic(4).toItem().setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab);
	public static final Item pellet_rtg_depleted_neptunium = new ItemHazard(ACTIVATION,3.75F, true, "pellet_rtg_depleted_neptunium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab);
	public static final Item pellet_rtg_depleted_zirconium = new ItemHazard(ACTIVATION,2F, "pellet_rtg_depleted_zirconium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab);
	...
	public static final Item pellet_rtg_cobalt = new ItemRTGPellet(16, ItemRads.cobalt60, ItemHazard.rtg, "pellet_rtg_cobalt").setDecays(ModItems.pellet_rtg_depleted_zirconium, 46176588L, 2).addFire(5).toItem().setCreativeTab(MainRegistry.controlTab);
	...
	public static final Item pellet_charged = new ItemHazard(NEUTRONS,420F, "pellet_charged").setCreativeTab(MainRegistry.partsTab);
	...
	public static class Foods {
		...
		public static final Item bottle_rad = new ItemEnergy("bottle_rad").setContainerItem(bottle_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item bottle_sparkle = new ItemEnergy("bottle_sparkle").setContainerItem(bottle_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item bottle_quantum = new ItemEnergy("bottle_quantum").setContainerItem(bottle_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item bottle_cherry = new ItemEnergy("bottle_cherry").setContainerItem(bottle_empty).setCreativeTab(MainRegistry.consumableTab);
		...
		public static final Item bottle2_sunset = new ItemEnergy("bottle2_sunset").setContainerItem(bottle2_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item bottle2_fritz_special = new ItemEnergy("bottle2_fritz_special").setContainerItem(bottle2_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item bottle2_korl_special = new ItemEnergy("bottle2_korl_special").setContainerItem(bottle2_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item bottle2_fritz = new ItemEnergy("bottle2_fritz").setContainerItem(bottle2_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item bottle2_korl = new ItemEnergy("bottle2_korl").setContainerItem(bottle2_empty).setCreativeTab(MainRegistry.consumableTab);
		...
		public static final Item balefire_scrambled = new ItemHazardSoup(30, "balefire_scrambled").addRadiation(ItemHazard.radspice * ItemHazard.powder + ItemHazard.bf).addFire(6).addBlinding().addHydroReactivity(6).toItem().setCreativeTab(MainRegistry.consumableTab);
		public static final Item balefire_and_ham = new ItemHazardSoup(60, "balefire_and_ham").addRadiation(2 * ItemHazard.radspice * ItemHazard.powder + ItemHazard.bf).addFire(30).addBlinding().addHydroReactivity(6).toItem().setCreativeTab(MainRegistry.consumableTab);
		...
		public static final Item can_breen = new ItemEnergy("can_breen").setContainerItem(can_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item can_bepis = new ItemEnergy("can_bepis").setContainerItem(can_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item can_luna = new ItemEnergy("can_luna").setContainerItem(can_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item can_overcharge = new ItemEnergy("can_overcharge").setContainerItem(can_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item can_mrsugar = new ItemEnergy("can_mrsugar").setContainerItem(can_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item can_redbomb = new ItemEnergy("can_redbomb").setContainerItem(can_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item can_creature = new ItemEnergy("can_creature").setContainerItem(can_empty).setCreativeTab(MainRegistry.consumableTab);
		public static final Item can_smart = new ItemEnergy("can_smart").setContainerItem(can_empty).setCreativeTab(MainRegistry.consumableTab);
	}
	...
	public static class ToolSets {
		...
		public static final ToolMaterial matStarmetal = EnumHelper.addToolMaterial("HBM_STARMETAL", 3, 1000, 20.0F, 2.5F, 30).setRepairItem(new ItemStack(Ingots.ingot_starmetal));
		...
		public static final ToolMaterial matBismuth = EnumHelper.addToolMaterial("HBM_BISMUTH", 4, 0, 50F, 0.0F, 200).setRepairItem(new ItemStack(Ingots.ingot_bismuth));
		public static final Item bismuth_pickaxe = new ItemToolAbility(15F, -2.8F, 0, matBismuth, EnumToolType.MINER, "bismuth_pickaxe")
				...
				.addHitAbility(new WeaponAbility.BeheaderAbility())
				.setDepthRockBreaker();
		public static final ToolMaterial matVolcano = EnumHelper.addToolMaterial("HBM_VOLCANIC", 4, 0, 50F, 0.0F, 200).setRepairItem(new ItemStack(Ingots.ingot_bismuth));
		public static final Item volcanic_pickaxe = new ItemToolAbility(15F, -2.8F, 0, matVolcano, EnumToolType.MINER, "volcanic_pickaxe")
				...
				.addHitAbility(new WeaponAbility.BeheaderAbility())
				.setDepthRockBreaker();
		public static final ToolMaterial matChlorophyte = EnumHelper.addToolMaterial("HBM_CHLOROPHYTE", 5, 0, 50F, 0.0F, 200).setRepairItem(new ItemStack(Powders.powder_chlorophyte));
		public static final Item chlorophyte_pickaxe = new ItemToolAbility(20F, -2.8F, 0, matChlorophyte, EnumToolType.MINER, "chlorophyte_pickaxe")
				.addBreakAbility(new ToolAbility.HammerAbility(2))
				.addBreakAbility(new LuckAbility(4))
		...
		public static final Item mese_pickaxe = new ItemToolAbility(35F, -2.8F, 0, matMese, EnumToolType.MINER, "mese_pickaxe")
				...
				.addBreakAbility(new ToolAbility.SilkAbility())
				.addBreakAbility(new LuckAbility(9))
	...
	public static final ToolMaterial matDecCobalt = EnumHelper.addToolMaterial("HBM_COBALT2", 4, 1000, 15.0F, 2.5F, 25).setRepairItem(new ItemStack(Ingots.ingot_cobalt));
	...
	public static final Item debris_graphite = new ItemHazard("debris_graphite").addRadiation(90F).addFire(5).toItem().setCreativeTab(MainRegistry.controlTab);
	public static final Item debris_metal = new ItemHazard("debris_metal").addRadiation(15F).toItem().setCreativeTab(MainRegistry.controlTab);
	public static final Item debris_fuel = new ItemHazard("debris_fuel").addRadiation(1300F).addFire(15).toItem().setCreativeTab(MainRegistry.controlTab);
	public static final Item debris_concrete = new ItemHazard("debris_concrete").addRadiation(45F).toItem().setCreativeTab(MainRegistry.controlTab);
	...
	public static class RBMKFuel {
		...
		public static final ItemRBMKRod rbmk_fuel_hep239 = (ItemRBMKRod) new ItemRBMKRod(rbmk_pellet_hep239, "rbmk_fuel_hep")
				...
				;
		public static final ItemRBMKPellet rbmk_pellet_hep241 = (ItemRBMKPellet) new ItemRBMKPellet("Highly Enriched Plutonium-241", "rbmk_pellet_hep241").addRadiation(ItemRads.plutonium241, ItemHazard.billet).toItem();
		public static final ItemRBMKRod rbmk_fuel_hep241 = (ItemRBMKRod) new ItemRBMKRod(rbmk_pellet_hep241, "rbmk_fuel_hep241")
				...
				.setMeltingPoint(2744)
				.setFuelColor(0.314F, 0.349F, 0.337F)
				.addRadiation(ItemRads.plutonium241, ItemHazard.rod_rbmk).toItem()
				;
	...
	public static final Item boy_target_invalid = new ItemHazard(35F, "boy_target_invalid").addFire(2).toItem().setMaxStackSize(1).setCreativeTab(MainRegistry.nukeTab).setContainerItem(boy_bullet);
	...
	public static final Item egg_balefire_shard = new ItemHazard(GAMMA,ItemHazard.bf * ItemHazard.nugget, true, "egg_balefire_shard").setMaxStackSize(16).setCreativeTab(MainRegistry.nukeTab);
	public static final Item egg_balefire = new ItemHazard(GAMMA,ItemHazard.bf, true, "egg_balefire").setMaxStackSize(1).setCreativeTab(MainRegistry.nukeTab);
	...
	public static final Item missile_customnuke = new ItemMissileCustomNuke("missile_customnuke").setCreativeTab(MainRegistry.missileTab);
	...
	public static class MissileParts {
	...
	public static class BlockItems {
		...
		public static final Item door_fuckoff = new ItemModDoor("door_fuckoff").setCreativeTab(null);
	}
	...
	public static final ItemWandSaving wand_leaf = (ItemWandSaving)new ItemWandSaving("wand_leaf").setMaxStackSize(1).setCreativeTab(MainRegistry.consumableTab);
	...
	public static class DummyTexs { // just why??
		//Dummy texture items
	...
	public static void preInit(){
		MainRegistry._initMemberClasses(ModItems.class);

...
public class MeteorDungeonRoom4 extends CellularDungeonRoom {
	
	public MeteorDungeonRoom4(CellularDungeon parent, CellularDungeonRoom daisyChain, EnumFacing dir) {
		super(parent);

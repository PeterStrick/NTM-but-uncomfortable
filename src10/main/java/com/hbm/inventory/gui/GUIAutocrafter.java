...
public class GUIAutocrafter extends GuiInfoContainer {
    ...
    public void drawScreen(int x, int y, float interp) {
        ...
        this.drawElectricityInfo(this, x, y, guiLeft + 17, guiTop + 44, 16, 52, diFurnace.getPower(), diFurnace.getMaxPower());
            ...
            for(int i = 0; i < 9; ++i) {
                ...
                if(this.isMouseOverSlot(slot, x, y) && diFurnace.matcher.modes[i] != null) {
                    ...
                    switch(diFurnace.matcher.modes[i]) {
                        ...
                        default: label += I18nUtil.resolveKey("desc.oredictmatch")+" "+ diFurnace.matcher.modes[i]; break;
                    }
